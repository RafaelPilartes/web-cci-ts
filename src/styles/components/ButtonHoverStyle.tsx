...
export const CircleHover = ({ children, className, ...props }: ButtonProps) => {
  return (
    <button
      {...props}
      className="relative flex h-[50px] w-40 items-center justify-center overflow-hidden bg-primary-200 text-white shadow-md transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-orange-600 before:duration-500 before:ease-out hover:shadow-orange-600 hover:before:h-56 hover:before:w-56 active:scale-90"
    >
      <span className="relative flex flex-row justify-center items-center gap-2 z-[2]">
        {children}
      </span>
